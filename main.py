...
DISPLAY_NAMES = {
    ...
    'Listaria': 'Listaria',
    'Pleasant Adultery Village': 'Pleasant Adultery Village',
    'My Secret Summer Vacation 2': 'My Secret Summer Vacation 2',
    'Daily Love Life with Mother': 'Daily Love Life with Mother',
    'Unholy Maiden': 'Unholy Maiden',
    'Isekai Kabukicho': 'Isekai Kabukicho',
    'Slutty Witches': 'Slutty Witches',
    'QOS MILF': 'QOS MILF',
    'Careless Sister': 'Careless Sister',
    'Shoot NPC': 'Shoot NPC',
    'House Chores': 'House Chores',
    'MRYG': 'MRYG',
    'OVER Devil': 'OVER Devil',
    'Broken Eden': 'Broken Eden',
    'NTR Priestess': 'NTR Priestess',
    'Town of Passion': 'Town of Passion',
    'Golden Canary': 'Golden Canary',
    'Aisha Futa Diaries': "Aisha's Futa Diaries",
    'Alicia': '淫紋憑きのマザー・アリシア',
    'Yokai Busters': '爆乳退散！妖怪バスターズ',
}
